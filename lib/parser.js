...
const OperatorsBooleanTerm = new Set([Lexer.TokenTypes.LT, Lexer.TokenTypes.GT, Lexer.TokenTypes.EQ, Lexer.TokenTypes.LEQ, Lexer.TokenTypes.GEQ, Lexer.TokenTypes.NEQ]);
const OperatorsBooleanExpr = new Set([Lexer.TokenTypes.AND, Lexer.TokenTypes.OR, Lexer.TokenTypes.XOR]);
...
module.exports = class Parser {
  ...
  */
  ...
  boolean_factor() {
    ...
    let tok = this.currentToken;
    if (this.eat(Lexer.TokenTypes.NOT)) {
      const rhs = this.boolean_expr();
      if (rhs === null) {
        console.log("Invalid BOOLEAN_EXPR after NOT unary operator");
        return null;
      } else {
      ...
      if (!this.eat(Lexer.TokenTypes.RPAREN)) {
        console.log("Missing RPAREN in BOOLEAN_FACTOR");
        return null;
      }
  ...
  boolean_term() {
    ...
    let result = this.binaryProduction(this.boolean_factor, OperatorsBooleanTerm);
    return result;
  }

  boolean_expr() {
    // boolean_expr : boolean_term ((AND | OR | XOR) boolean_term)*
    let result = this.binaryProduction(this.boolean_term, OperatorsBooleanExpr);
    return result;
  }
