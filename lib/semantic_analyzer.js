...
class SemanticAnalyzer {
  ...
  visit_BINOP(node) {
    // + expects reals or integers; returns real if one is real, otherwise integer
    // - expects reals or integers; returns real if one is real, otherwise integer
    // * expects reals or integers; returns real if one is real, otherwise integer
    // / expects reals or integers; always returns real
    // div expects integers and returns an integer
